...
export function EstimateForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-5">
      ...
      {/* SMS consent — UNCHECKED by default, and the label states what they are
          agreeing to. The CRM records this value but does not require it, so an
          unchecked box never costs the customer their estimate. */}
      <div className="rounded border border-sawdust-dim bg-white/60 p-4">
        <label htmlFor="smsConsent" className="flex cursor-pointer gap-3">
          ...
          <span className="text-sm leading-relaxed text-ink-soft">
            Text me about my estimate. Message frequency varies, message and data rates may
            apply, reply STOP to cancel or HELP for help. Optional — leaving this unticked
            will not hold up your estimate.
          </span>
        </label>
      </div>
